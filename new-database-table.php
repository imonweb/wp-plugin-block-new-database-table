...
class PetAdoptionTablePlugin {
  function __construct() {
    ...
    /*---  generate 100,0000 data into databse wp_pets ---*/
    // add_action('admin_head', array($this, 'populateFast'));
    
    /*---  generate 1 data into databse wp_pets ---*/
  ...
  function onActivate() {
    ...
    dbDelta("CREATE TABLE $this->tablename (
      ...
      birthyear smallint(20) NOT NULL DEFAULT 0,
      petweight smallint(20) NOT NULL DEFAULT 0,
